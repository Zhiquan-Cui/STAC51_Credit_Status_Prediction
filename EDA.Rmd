...
Based on the above table, we conclude that the following variables are dependent 
to most of the variables with $\alpha=0.05$ according to Pearson's Chi-sq Test of Independence:
...
Based on the above Cramer's V table, we conclude that we will drop the following 
variables because of their high correlation to other variables:
